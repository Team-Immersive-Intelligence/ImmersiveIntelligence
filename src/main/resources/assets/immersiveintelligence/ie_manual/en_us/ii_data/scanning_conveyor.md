...
The **Scanning Conveyor** is a device used for precise [item detection](data_types.md#itemstack) with [data packets](data_main.md#packetsbasics).
...
To further process the received packet, an [ALM](arithmetic_logic_machine.md) with the [proper circuit](_functional_circuits.md#itemstack) can be used to extract desired information from the ItemStack.
# uses
