...
# details
The machine consists of several parts, but key parts are the [data input port], on which a [data connector](data_wiring.md#connector) has to be placed and the [redstone output connector](redstoneWires#1) to which you can attach a [wire](wiring#redstoneWires).
# interface
In the user interface there are two sections: data to redstone and the opposite.
After you add an entry, you must specify the variable letter and the corresponding redstone color.
