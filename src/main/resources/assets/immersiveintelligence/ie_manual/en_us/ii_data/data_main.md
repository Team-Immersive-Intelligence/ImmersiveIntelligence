...
# intro
With the growth of a facility such as a factory or power plant, the need for a sophisticated [control system] increases.
Initially, the good old redstone wiring will suffice, but as complicated machinery is deployed, the messy nature of redstone starts to show - and that's an appropriate moment to introduce the [Data System].
# packets_basics
...
As shown, even a simple **Packet** like the above example carries much more information than what could be passed by a Redstone wire at once!
# packets_demo2
...
All those values were combined into a single **Packet**, making the transmission much more [compact] and [straight-forward] that if it were to be built using traditional redstone circuitry.
# packets_info
