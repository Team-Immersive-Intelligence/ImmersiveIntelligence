...
# punchtape_reader
The **Punchtape Reader** is a device used to read [punchtapes] based on a received [data packet](data_main.md#packetsbasics).<br>
|[crafting]{source:"reader"}|
# punchtape_reader2
The **Punchtape Reader** has 3 modes of control by redstone:
