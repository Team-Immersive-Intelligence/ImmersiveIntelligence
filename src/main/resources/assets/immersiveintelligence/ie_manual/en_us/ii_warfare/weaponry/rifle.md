...
# 2
|[machine_recipe]{type:"precision_assembler", recipe:"precision_rifle"}|
<br>Fabricated with precision, the [Rifle] is an improvement over the handmade version.
...
[Extended Barrel](weapon_upgrades.md#21)