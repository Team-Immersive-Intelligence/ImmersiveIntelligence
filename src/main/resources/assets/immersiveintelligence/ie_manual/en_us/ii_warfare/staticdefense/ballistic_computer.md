...
The Ballistic Computer is a complex calculation device that translates a position vector and bullet mass to yaw and pitch used by some [data-driven](data_main.md) [weapons](artillery_howitzer.md).
# guide
