...
# info0
|[upgrade_display]{upgrade:"immersiveintelligence:mg_loader"}|
With a [wrench], you can modify the crate to fit a [belt-fed machingun](weapon_upgrades.md#3).<br>
|[upgrade_display]{upgrade:"immersiveintelligence:inserter"}|
You may also install an inserter for a way to load turrets by [data](data_main.md). 
