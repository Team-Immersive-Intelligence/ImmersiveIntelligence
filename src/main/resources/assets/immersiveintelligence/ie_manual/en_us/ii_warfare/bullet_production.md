...
<br>**The Filler** is a device used to fill containers with dusts. The most important usage is filling [bullet casings] with [gunpowder].
...
This device is formed by using a [hammer](introduction#introductionHammer) on the heavy engineering block between the wooden scaffolding. **(Currently WIP)**