...
A Show of Force
# intro
An [Emplacement] does not have any weapon installed by default. Instead, the weapon is assembled on the emplacement using the [Wrench](electric_tools.md#wrench).
