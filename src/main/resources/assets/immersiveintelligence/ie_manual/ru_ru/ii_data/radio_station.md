...
**Радиостанция** — это устройство для беспроводной передачи, приема и ретрансляции [пакетов данных](data_main.md#packetsbasics). Поскольку это сложная конструкция, для сборки требуют [электрический молоток](electric_tools.md) и удар по [продвинутому электронному инженерному блоку].
# details
