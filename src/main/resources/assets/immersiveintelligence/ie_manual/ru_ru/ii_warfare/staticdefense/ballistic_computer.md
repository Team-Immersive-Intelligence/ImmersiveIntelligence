...
Баллистический компьютер - сложный калькулятор преобразующий относительные координаты цели в направление выстрела в виде [данных](data_main.md) для [орудий](artillery_howitzer.md).
# guide
