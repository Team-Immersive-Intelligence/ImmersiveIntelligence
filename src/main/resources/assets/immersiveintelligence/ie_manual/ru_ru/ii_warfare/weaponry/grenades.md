...
# 1
[Рельсотронные гранаты] - это боеприпасы для [рельсотрона] (railgun) и [Тяжелого рельсотрона] (emplacement_weapons.md#railgun0), которые можно использовать вместо стандартных стержней.
Они могут быть начинены взрывчаткой или шрапнелью и затем использоваться в качестве переносного гранатомёта.
