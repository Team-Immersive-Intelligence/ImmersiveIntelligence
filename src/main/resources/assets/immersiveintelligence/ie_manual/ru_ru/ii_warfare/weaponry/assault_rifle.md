...
# 1
Мощное, полностью автоматическое оружие, [автомат] использует [промежуточные патроны] из [магазина](magazines.md), который заполняется [упаковщиком](packer.md). Инженерный департамент внедрил в автомат существенную [модульность](#2), чтобы ее можно было адаптировать практически к любой ситуации. Автомат поддерживает автоматический или полуавтоматический режимы.
