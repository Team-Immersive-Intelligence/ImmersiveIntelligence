...
# casings
All bullets start with the **casing
**. Most casings can be produced using an appropriate mold in the [Metal Press](metalPress) but some, like the [Radio Explosives](explosives_mines.md#radio_satchel0), require crafting.<br>
|[item_display]{source:"casing"}|
# filler
|[multiblock]{mb:"II:Filler"}|
<br>**The Filler
** is a device used to fill containers with dusts. The most important usage is filling [bullet casings] with [gunpowder].
# filler_1
...
The **Projectile Workshop
** is a machine used to manufacture or fill [cores]. To form it, use a [hammer](introduction#introductionHammer) on the left metal crate.
...
The core is produced in the **Projectile Workshop
** using various metal nuggets. Keep in mind to use [the appropriate metal for the job](bullet_cores.md).
...
To form the **Ammunition Assembler
**, use a [hammer](introduction#introductionHammer) on the center steel scaffolding that is exposed.
