...
# 0
|[crafting]{source:"lea"}|
Лёгкая броня инженера - это универсальная и [очень защищающая] спецодежда.
Изготовленная из кожи, стали и сделанная с высокой точностью [на верстаке], она защищает от любых противников, с которыми вы можете столкнуться [лучше, чем большинство доспехов].
# 1
...
[Инженерные очки] объединяют эффекты [инфракрасных] и [технических] очков в одном устройстве.
...
На один [элемент брони] можно установить только [3] пластины.
# 7
|[crafting]{source:"composite_armor_plates"}|
Благодаря своей высокой плотности и твердости, [композитный материал] легко превосходит сталь в бронезащите.
Однако твердость материала означает, что [удар по броне холодным оружием нанесет ей серьезный ущерб]. На один [элемент брони] можно установить только [3] пластины.
# 8
|[crafting]{source:"hazmat_coating"}|
[Защитное покрытие] — это дополнительный внутренний изолирующий слой, защищающий от [радиации] и [кислот].
...
[Камуфляжная сетка] — это простая сетка с прикрепленными к ней листьями, позволяющая пользователю сливаться с листвой для [скрытного передвижения].
...
[Сетка с поглощением ИК-излучения] поглощает излучаемый инфракрасный свет, служа идеальным способом скрыться от [инфракрасных датчиков](emplacement_weapons.md#ir_observer0).
Однако из-за своей конструкции попадание под действие [электромагнитного оружия] причинит [наносит больше урона].
# 13
|[crafting]{source:"scuba_tank"}|
[Акваланг] позволяет дольше оставаться под водой [без необходимости всплывать на поверхность для пополнения запаса воздуха].
Его можно заправить кислородом на [разливочном аппарате](bottlingMachine), что особенно удобно при подводных строительных работах. Для работы требуется [противогаз](#2).
# 14
|[crafting]{source:"exoskeleton"}|
[Экзоскелет] позволяет пользователю [бегать быстрее] благодаря сложной системе двигателей и гидравлики.
...
[Укреплённые  ботинки] состоит из нескольких стальных пластин, скрепленных кожаными ремнями. Оно [добавляет дополнительную броню] и [защищает владельца от огня].
# 16
|[crafting]{source:"flippers"}|
[Ласты] позволяют быстро передвигаться в жидкостях. Они отлично работают с [аквалангом](#13) и [противогазом](#2).
# 17
|[crafting]{source:"snow_rackets"}|
[Снегоступы] повышают устойчивость на снегу и льду, позволяя пользователю с легкостью преодолевать скользкие поверхности.
# 18
|[crafting]{source:"internal_springs"}|
[Внутренние пружины] смягчают ударную силу при приземлении, [защищая пользователя от травм при падении]. В сочетании с резиновыми накладками на подошве делает шаги [практически бесшумными].