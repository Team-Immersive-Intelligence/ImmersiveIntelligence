...
Для его создания используйте [электрический молоток](electric_tools.md) на левом деревянном ых лесах.
# radar 2
Радар имеет множество применений. Его можно связать со стационарными орудиями, такими как [СПСО](emplacement_weapons.md#cpds0), и использовать для перехвата снарядов на больших дистанциях. Его также можно связать со [стратегической штабным столом](strategic_command_table.md) [(WIP)]. Для работы радару требуется постоянное электроснабжение.
# upgrade
