...
Это можно изменить, выбрав другой режим выбора. Вы можете выбрать между определенным количеством слотов инвентаря или количеством предметов. Количество можно указать в интерфейсе, в поле ввода ниже.
# details_20
