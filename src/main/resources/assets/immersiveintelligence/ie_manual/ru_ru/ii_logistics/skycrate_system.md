...
Рамки фуниклёра используются для транспортировки ящиков по канатной дороге. Существует две модели: базовая и электрическая, использующая энергию, получаемую по пути от расположенных рядом [катушек Теслы](teslaCoil).