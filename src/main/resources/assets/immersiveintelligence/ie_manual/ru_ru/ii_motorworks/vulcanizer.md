...
Вулканизация — это заключительный этап процесса [производства резины](rubber_production.md). Для сборки вулканизатора используйте [молоток](introduction#introductionHammer) на стальном блоке, ближайшем к резервуару.
# production
Используя нагрев, давление, [формы](#molds) и вулканизирующие компоненты, [вулканизатор] превращает сырые резиновые листы в привычную промышленную резину.
