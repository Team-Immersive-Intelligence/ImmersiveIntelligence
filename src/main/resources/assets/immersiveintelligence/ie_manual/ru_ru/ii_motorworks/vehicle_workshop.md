...
# fuel
Если транспортное средство расходует топливо, его заправляет наполовину при создании, используя внутренний бак мастерской. Топлива хватит ненадолго, поэтому стоит подумать о строительстве [заправочной станции](fuel_station.md).
# upgrades
