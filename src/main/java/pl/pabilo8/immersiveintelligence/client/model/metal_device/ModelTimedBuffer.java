 ...
 */
public class ModelTimedBuffer extends BaseBlockModel
{
	int textureX = 64;
	int textureY = 64;
	...
	public ModelTimedBuffer() //Same as Filename
	{
		...
		baseModel[1] = new ModelRendererTurbo(this, 24, 40, textureX, textureY); // Box 0
		baseModel[2] = new ModelRendererTurbo(this, 36, 19, textureX, textureY); // Box 0
		...
		baseModel[8] = new ModelRendererTurbo(this, 50, 22, textureX, textureY); // Box 0
		baseModel[9] = new ModelRendererTurbo(this, 37, 28, textureX, textureY); // Box 0
		...
		baseModel[9].addBox(0F, 0F, 0F, 1, 5, 5, 0F); // Box 0
		baseModel[9].setRotationPoint(14F, -13.5F, 4.5F);
		...
		clockModel = new ModelRendererTurbo[1];
		clockModel[0] = new ModelRendererTurbo(this, 28, 37, textureX, textureY); // Box 0
		clockModel[0].addBox(0.5F, -0.5F, 0F, 1, 1, 2, 0F); // Box 0
		clockModel[0].setRotationPoint(14F, -11F, 7F);
	...
	public void render()
	{
		super.render();
		float f5 = 1F/16F;
		for(ModelRendererTurbo model : clockModel)
			model.render(f5);
	}
}
