...
public class ModelAmmunitionFactory extends BaseBlockModel
{
	...
	{
		baseModel = new ModelRendererTurbo[49];
		...
		baseModel[10] = new ModelRendererTurbo(this, 32, 165, textureX, textureY); // BaseTop
		...
		baseModel[35] = new ModelRendererTurbo(this, 59, 187, textureX, textureY); // MainPipe
		...
		baseModel[9].addBox(0F, 0F, 0F, 5, 13, 1, 0F); // BaseTop
		baseModel[9].setRotationPoint(52F, -32F, 48F);

		baseModel[10].addBox(0F, -2F, -1F, 5, 13, 1, 0F); // BaseTop
		baseModel[10].setRotationPoint(52F, -30F, 64F);
		...
		baseModel[35].setRotationPoint(33F, -26F, 10F);

		baseModel[36].addBox(0F, 0F, 0F, 16, 2, 2, 0F); // Pipe
		baseModel[36].setRotationPoint(17F, -25F, 22F);

		baseModel[37].addBox(0F, 0F, 11F, 1, 4, 4, 0F); // MainPipe
		baseModel[37].setRotationPoint(17F, -26F, 10F);

		baseModel[38].addBox(0F, 0F, -2F, 16, 16, 15, 0F); // CloacksBase
		baseModel[38].setRotationPoint(17F, -32F, 3F);

		baseModel[39].addBox(19F, -30F, 0F, 6, 6, 1, 0F); // Cloak
		baseModel[39].setRotationPoint(-1F, 0F, 0F);

		baseModel[40].addBox(0F, 0F, 0F, 6, 6, 1, 0F); // Cloak1
		baseModel[40].setRotationPoint(26F, -30F, 0F);

		baseModel[41].addBox(0F, 0F, 0F, 12, 2, 2, 0F); // Pipe2
		baseModel[41].setRotationPoint(59F, -36F, 18.5F);
		...
		baseModel[42].setRotationPoint(71F, -36F, 18.5F);

		baseModel[43].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Pipe2
		baseModel[43].setRotationPoint(70F, -33F, 17.5F);
