...
public class ModelPrecisionBuzzsaw extends ModelIIBase
{
	...
	public ModelPrecisionBuzzsaw() //Same as Filename
	{
		...
		inserterUpperArm = new ModelRendererTurbo[4];
		...
		inserterUpperArm[2] = new ModelRendererTurbo(this, 0, 28, textureX, textureY); // Holder1
		inserterUpperArm[3] = new ModelRendererTurbo(this, 0, 28, textureX, textureY); // Holder2
		...
		inserterUpperArm[2].addShape3D(1.5F, 0F, 2F, new Shape2D(new Coord2D[]{new Coord2D(0, 0, 0, 0), new Coord2D(3, 0, 3, 0), new Coord2D(3, 2, 3, 2), new Coord2D(2, 3, 2, 3), new Coord2D(1, 3, 1, 3), new Coord2D(0, 2, 0, 2)}), 1, 3, 3, 12, 1, ModelRendererTurbo.MR_FRONT, new float[]{2, 2, 1, 2, 2, 3}); // Holder1
		inserterUpperArm[2].rotateAngleY = -1.57079633F;

		inserterUpperArm[3].addShape3D(1.5F, 0F, 2F, new Shape2D(new Coord2D[]{new Coord2D(0, 0, 0, 0), new Coord2D(3, 0, 3, 0), new Coord2D(3, 2, 3, 2), new Coord2D(2, 3, 2, 3), new Coord2D(1, 3, 1, 3), new Coord2D(0, 2, 0, 2)}), 1, 3, 3, 12, 1, ModelRendererTurbo.MR_FRONT, new float[]{2, 2, 1, 2, 2, 3}); // Holder2
		inserterUpperArm[3].rotateAngleY = -4.71238898F;

		inserterSaw = new ModelRendererTurbo[2];
		inserterSaw[0] = new ModelRendererTurbo(this, 20, 29, textureX, textureY); // InserterAxleTop
		inserterSaw[1] = new ModelRendererTurbo(this, 14, -16, textureX, textureY); // InserterSaw

		inserterSaw[0].addBox(-3F, -0.5F, -0.5F, 5, 1, 1, 0F); // InserterAxleTop

		inserterSaw[1].addBox(-1F, -8F, -8F, 0, 16, 16, 0F); // InserterSaw
		flipAll();
	...
	public void renderProgress(float progress, float angle, float maxProgress)
	{
		...
		GlStateManager.rotate(progress2*1440, 1f, 0f, 0f);
		inserterSaw[0].render(0.0625f);
		GlStateManager.scale(0.5, 0.5, 0.5);
		inserterSaw[1].render(0.0625f);
		//for(ModelRendererTurbo mod : inserterSaw)
		//	mod.render(0.0625f);
