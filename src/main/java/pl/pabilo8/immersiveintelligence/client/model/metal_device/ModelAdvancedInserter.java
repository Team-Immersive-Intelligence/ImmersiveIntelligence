 ...
 */
public class ModelAdvancedInserter extends BaseBlockModel
{
	...
	public ModelAdvancedInserter() //Same as Filename
	{
		...
		inserterUpperArm = new ModelRendererTurbo[13];
		...
		inserterUpperArm[2] = new ModelRendererTurbo(this, 35, 32, textureX, textureY); // InserterArm2TopProjector
		inserterUpperArm[3] = new ModelRendererTurbo(this, 0, 32, textureX, textureY); // InserterArm2TopProjectorUpper
		inserterUpperArm[4] = new ModelRendererTurbo(this, 7, 42, textureX, textureY); // InserterArm2TopProjectorMiddle
		inserterUpperArm[5] = new ModelRendererTurbo(this, 15, 37, textureX, textureY); // InserterArm2TopProjectorMiddle
		inserterUpperArm[6] = new ModelRendererTurbo(this, 0, 36, textureX, textureY); // InserterArm2TopProjectorMiddle
		inserterUpperArm[7] = new ModelRendererTurbo(this, 29, 32, textureX, textureY); // InserterArm2Top
		inserterUpperArm[8] = new ModelRendererTurbo(this, 32, 34, textureX, textureY); // InserterArm2TopProjectorUpper
		inserterUpperArm[9] = new ModelRendererTurbo(this, 32, 34, textureX, textureY); // InserterArm2TopProjectorUpper
		inserterUpperArm[10] = new ModelRendererTurbo(this, 27, 42, textureX, textureY); // InserterArm2TopProjectorMiddle
		inserterUpperArm[11] = new ModelRendererTurbo(this, 15, 32, textureX, textureY); // InserterArm2TopProjectorMiddle
		inserterUpperArm[12] = new ModelRendererTurbo(this, 23, 37, textureX, textureY); // InserterArm2TopProjectorMiddle
		...
		inserterUpperArm[2].addBox(-3F, -2F, 0.5F, 6, 1, 6, 0F); // InserterArm2TopProjector

		inserterUpperArm[3].addBox(-1.5F, -9F, 1.5F, 3, 1, 3, 0F); // InserterArm2TopProjectorUpper

		inserterUpperArm[4].addShapeBox(-2.5F, -3F, 0.5F, 5, 1, 5, 0F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F); // InserterArm2TopProjectorMiddle

		inserterUpperArm[5].addShapeBox(-1.5F, -8F, 1.5F, 3, 1, 3, 0F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.25F); // InserterArm2TopProjectorMiddle

		inserterUpperArm[6].addShapeBox(-2.5F, -5F, 0.5F, 5, 1, 5, 0F, -1F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F); // InserterArm2TopProjectorMiddle

		inserterUpperArm[7].addFlexTrapezoid(-2.5F, -9F, 0.5F, 5, 1, 1, 0F, 0.00F, 0.00F, -1.00F, -1.00F, -1.00F, -1.00F, ModelRendererTurbo.MR_FRONT); // InserterArm2Top

		inserterUpperArm[8].addBox(-2.5F, -9F, 1.5F, 1, 1, 2, 0F); // InserterArm2TopProjectorUpper

		inserterUpperArm[9].addBox(1.5F, -9F, 1.5F, 1, 1, 2, 0F); // InserterArm2TopProjectorUpper

		inserterUpperArm[10].addShapeBox(-2.5F, -4F, 0.5F, 5, 1, 5, 0F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F); // InserterArm2TopProjectorMiddle

		inserterUpperArm[11].addShapeBox(-2F, -7F, 1F, 4, 1, 4, 0F, -1F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F); // InserterArm2TopProjectorMiddle

		inserterUpperArm[12].addShapeBox(-2F, -6F, 1F, 4, 1, 4, 0F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F, -0.75F, 0F, -0.75F); // InserterArm2TopProjectorMiddle
