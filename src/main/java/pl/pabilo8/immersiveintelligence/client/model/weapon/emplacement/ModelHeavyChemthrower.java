...
public class ModelHeavyChemthrower extends ModelIIBase
{
	...
	public ModelHeavyChemthrower() //Same as Filename
	{
		...
		baseModel[0].setRotationPoint(8F, -2F, 8F);
		...
		turretModel[0].setRotationPoint(10F, -4F, 10F);

		turretModel[1].addBox(0F, 0F, 0F, 16, 1, 16, 0F); // Box 4
		turretModel[1].setRotationPoint(8F, -5F, 8F);

		turretModel[2].addBox(0F, 0F, 0F, 18, 6, 13, 0F); // Box 5
		turretModel[2].setRotationPoint(7F, -17F, 11F);
		...
		turretModel[3].setRotationPoint(7F, -20F, 7F);
		...
		turretModel[5].setRotationPoint(14.5F, -20F, 15F);
		...
		turretModel[6].setRotationPoint(14F, -24F, 5F);
		...
		turretModel[9].setRotationPoint(7F, -20F, 11F);
		...
		turretModel[10].setRotationPoint(23F, -20F, 7F);
		...
		turretModel[11].setRotationPoint(14F, -20F, 7F);
		...
		turretModel[12].setRotationPoint(14F, -24F, 7F);
		...
		turretModel[13].setRotationPoint(14F, -24F, 12F);
		...
		turretModel[18].setRotationPoint(7F, -11F, 7F);
		...
		turretModel[21].setRotationPoint(6F, -13F, 9F);

		turretModel[22].addShapeBox(0F, 0F, 0F, 14, 1, 4, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 33
		turretModel[22].setRotationPoint(9F, -12F, 7F);

		turretModel[23].addBox(0F, 0F, 0F, 8, 15, 8, 0F); // Box 56
		turretModel[23].setRotationPoint(20F, -21F, 24F);
		...
		turretModel[25].setRotationPoint(23.5F, -22F, 24.5F);

		turretModel[26].addBox(0F, 0F, 0F, 1, 6, 6, 0F); // Box 59
		turretModel[26].setRotationPoint(28F, -13F, 25F);

		turretModel[27].addBox(0F, 0F, 0F, 9, 1, 9, 0F); // Box 60
		turretModel[27].setRotationPoint(19.5F, -16F, 23.5F);
		...
		turretModel[30].setRotationPoint(3F, -13F, 25F);

		turretModel[31].addBox(0F, 0F, 0F, 8, 15, 8, 0F); // Box 64
		turretModel[31].setRotationPoint(4F, -21F, 24F);

		turretModel[32].addBox(0F, 0F, 0F, 9, 1, 9, 0F); // Box 65
		turretModel[32].setRotationPoint(3.5F, -16F, 23.5F);

		turretModel[33].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 66
		turretModel[33].setRotationPoint(4.5F, -22F, 24.5F);

		turretModel[34].addBox(0F, 0F, 0F, 7, 2, 7, 0F); // Box 67
		turretModel[34].setRotationPoint(4.5F, -6.5F, 24.5F);

		turretModel[35].addShapeBox(0F, 0F, 0F, 3, 4, 1, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 68
		turretModel[35].setRotationPoint(6F, -8F, 10F);
		...
		turretModel[36].setRotationPoint(3F, -12F, 11F);

		turretModel[37].addShapeBox(0F, 0F, 0F, 4, 4, 13, 0F, -0.25F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, -0.575F, 0F, 0F, 0.375F, -0.25F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, -0.575F, 0F, 0F, 0.375F); // Box 70
		turretModel[37].setRotationPoint(3F, -12F, 13F);
		...
		turretModel[39].setRotationPoint(2F, -14F, 17F);
		...
		turretModel[40].setRotationPoint(29F, -14F, 17F);
		...
		turretModel[41].rotateAngleY = -3.14159265F;
		...
		turretModel[42].setRotationPoint(18.5F, -10F, 4F);
		...
		turretModel[43].setRotationPoint(9.5F, -10F, 4F);

		turretModel[44].addBox(0F, 0F, 0F, 3, 4, 3, 0F); // Box 68
		turretModel[44].setRotationPoint(0F, -12F, 26F);

		turretModel[45].addShapeBox(0F, 0F, 0F, 3, 4, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 68
		turretModel[45].setRotationPoint(3F, -8F, 29F);
		turretModel[45].rotateAngleZ = 3.14159265F;

		turretModel[46].addBox(0F, 0F, 0F, 1, 6, 6, 0F); // Box 31
		turretModel[46].setRotationPoint(25F, -13F, 9F);

		turretModel[47].addShapeBox(0F, 0F, 0F, 3, 4, 1, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 68
		turretModel[47].setRotationPoint(26F, -12F, 10F);
		...
		turretModel[48].setRotationPoint(26F, -12F, 11F);

		turretModel[49].addShapeBox(0F, 0F, 0F, 4, 4, 13, 0F, 0F, 0F, 0F, -0.25F, 0F, -1F, 0F, 0F, 0.375F, 0F, 0F, -0.575F, 0F, 0F, 0F, -0.25F, 0F, -1F, 0F, 0F, 0.375F, 0F, 0F, -0.575F); // Box 70
		turretModel[49].setRotationPoint(25.13F, -12F, 13.85F);
		turretModel[49].rotateAngleY = -0.2268928F;

		turretModel[50].addBox(0F, 0F, 0F, 3, 4, 3, 0F); // Box 68
		turretModel[50].setRotationPoint(29F, -12F, 26F);

		turretModel[51].addShapeBox(0F, 0F, 0F, 3, 4, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 68
		turretModel[51].setRotationPoint(29F, -12F, 29F);

		turretModel[52].addShapeBox(0F, 0F, 0F, 18, 3, 4, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 14
		turretModel[52].setRotationPoint(7F, -20F, 16F);
		...
		barrelStartModel[0].setRotationPoint(10.5F, -15F, -1F);

		barrelStartModel[1].addShapeBox(-2.5F, -3.5F, 0F, 5, 7, 3, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // GUN102
		...
		barrelStartModel[2].setRotationPoint(19.5F, -15F, -1F);

		barrelStartModel[3].addShapeBox(-2.5F, -3.5F, 0F, 5, 7, 3, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // GUN104
		...
		barrelMidModel[0].setRotationPoint(11F, -14.5F, -10F);
		...
		barrelMidModel[1].setRotationPoint(20F, -14.5F, -10F);
		...
		barrelEndModel[0].setRotationPoint(11.5F, -14F, -19F);
		...
		barrelEndModel[1].setRotationPoint(10.5F, -15F, -27F);
		...
		barrelEndModel[2].setRotationPoint(20.5F, -14F, -19F);
		...
		barrelEndModel[3].setRotationPoint(19.5F, -15F, -27F);
		...
		barrelEndModel[4].setRotationPoint(11.5F, -14F, -26F);
		...
		barrelEndModel[5].setRotationPoint(20.5F, -14F, -26F);
