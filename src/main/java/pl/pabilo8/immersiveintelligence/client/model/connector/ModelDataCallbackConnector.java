...
public class ModelDataCallbackConnector extends ModelBlockBase
{
	int textureX = 32;
	int textureY = 32;

	public ModelDataCallbackConnector() //Same as Filename
	{
		...
		baseModel[0].addBox(-4F, 6F, -4F, 8, 2, 8, 0F); // BoxBotton
		...
		baseModel[5].addBox(-4F, 2F, -4F, 8, 2, 8, 0F); // BoxTop
