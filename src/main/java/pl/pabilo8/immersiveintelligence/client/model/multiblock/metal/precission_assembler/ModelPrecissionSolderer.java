 ...
 * @since 17-07-2019
 */
public class ModelPrecissionSolderer extends ModelBlockBase
{
	public ModelRendererTurbo[] inserterLowerArm, inserterMidAxle, inserterUpperArm, inserterBaseTurntable;
	int textureX = 64;
	int textureY = 32;

	public ModelPrecissionSolderer() //Same as Filename
	{
		...
		inserterUpperArm[2].addShapeBox(-1F, -10F, -7.5F, 2, 2, 6, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.25F, -0.25F, 0F, -0.25F, -0.25F, 0F); // InserterArmSolderer
	...
	public void renderProgress(float progress, float angle, float maxProgress)
	{
		...
		ClientUtils.bindTexture(ImmersiveIntelligence.MODID+":textures/blocks/multiblock/precission_assembler/solderer.png");
