 ...
 */
public class ModelDataRelay extends BaseBlockModel
{
	int textureX = 32;
	int textureY = 32;

	public ModelDataRelay()
	{
		...
		baseModel[3].addTrapezoid(-2F, -8F, -2F, 4, 2, 4, 0F, 1.00F, ModelRendererTurbo.MR_BOTTOM); // BoxToppestTop
		baseModel[3].setRotationPoint(8F, -8F, 8F);

		baseModel[4].addBox(-3F, -4F, -3F, 6, 2, 6, 0F); // BoxMiddle
		baseModel[4].setRotationPoint(8F, -8F, 8F);

		baseModel[5].addBox(-4F, -6F, -4F, 8, 2, 8, 0F); // BoxTop
