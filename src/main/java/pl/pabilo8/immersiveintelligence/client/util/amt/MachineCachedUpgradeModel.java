...
public class MachineCachedUpgradeModel<T extends TileEntity & IUpgradableDevice> implements AMTRenderable
{
	...
	private MachineCachedUpgradeModel(MachineCachedUpgradeModelBuilder<T> builder)
	{
	...
	public static class MachineCachedUpgradeModelBuilder<T extends TileEntity & IUpgradableDevice>
	{
		...
		{
			return withConstructionModel(IIAnimationUtils.modelFromRes(modelLocation));
		}
		...
		public MachineCachedUpgradeModel<T> build()
		{
			...
			return new MachineCachedUpgradeModel<>(this);
		}
	}
}
