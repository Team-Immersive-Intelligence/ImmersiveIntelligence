...
public abstract class IITileRenderer<T extends TileEntity> extends TileEntitySpecialRenderer<T> implements IReloadableModelContainer<IITileRenderer<T>>
{
	...
	/**
	 * Used for automatic registration of tile entity renderers based on class and subscribing them to model and texture laoding lists.
	 */
	...
	/**
	 * Batched version of {@link RegisteredTileRenderer} to reduce boilerplate on classes with multiple registrations.
	 */
	@Retention(RetentionPolicy.RUNTIME)
	@Target({ElementType.TYPE})
