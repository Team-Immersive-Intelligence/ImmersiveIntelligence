...
public class IIManualDataAndElectronics extends IIManual
{
	...
	public void addPages()
	{
		...
		ManualHelper.addEntry("data_wires", getCategory(),
				new ManualPages.Crafting(ManualHelper.getManual(), "data_wires0", new ItemStack(IIContent.item_data_wire_coil)),
				new ManualPages.CraftingMulti(ManualHelper.getManual(), "data_wires1",
						new ItemStack(IIContent.block_data_connector, 1, IIBlockTypes_Connector.DATA_CONNECTOR.getMeta()),
						new ItemStack(IIContent.block_data_connector, 1, IIBlockTypes_Connector.DATA_RELAY.getMeta())
				)
		);
		...
		ManualHelper.addEntry("circuit_production", getCategory(),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "circuit_production0",
						...
						Utils.getStackWithMetaName(IIContent.item_material, "advanced_circuit_board"),
						Utils.getStackWithMetaName(IIContent.item_material, "processor_circuit_board")
				),

				new ManualPages.ItemDisplay(ManualHelper.getManual(), "circuit_production_basic",
						Utils.getStackWithMetaName(IIContent.item_material, "basic_circuit_board_raw"),
						Utils.getStackWithMetaName(IIContent.item_material, "basic_circuit_board_etched"),
						Utils.getStackWithMetaName(IIContent.item_material, "advanced_electronic_element"),
						new ItemStack(IEContent.itemMaterial, 1, 27)
				),
				...
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "circuit_production_advanced",
						Utils.getStackWithMetaName(IIContent.item_material, "advanced_circuit_board_raw"),
						Utils.getStackWithMetaName(IIContent.item_material, "advanced_circuit_board_etched"),
						Utils.getStackWithMetaName(IIContent.item_material, "advanced_electronic_element"),
						Utils.getStackWithMetaName(IIContent.item_material, "advanced_circuit_board")
				),
				...
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "circuit_production_processor",
						Utils.getStackWithMetaName(IIContent.item_material, "processor_circuit_board_raw"),
						Utils.getStackWithMetaName(IIContent.item_material, "processor_circuit_board_etched"),
						Utils.getStackWithMetaName(IIContent.item_material, "processor_electronic_element"),
						Utils.getStackWithMetaName(IIContent.item_material, "processor_circuit_board")
				),
		...
		ManualHelper.addEntry("arithmetic_logic_machine", getCategory(),
				...
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_arithmetic", new ItemStack(IIContent.item_circuit, 1, 0)),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_advanced_arithmetic", new ItemStack(IIContent.item_circuit, 1, 1)),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_logic", new ItemStack(IIContent.item_circuit, 1, 2)),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_comparator", new ItemStack(IIContent.item_circuit, 1, 3)),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_advanced_logic", new ItemStack(IIContent.item_circuit, 1, 4)),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_advanced_text", new ItemStack(IIContent.item_circuit, 1, 5)),
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "arithmetic_logic_machine_fcircuit_advanced_itemstack", new ItemStack(IIContent.item_circuit, 1, 6))
		);
		...
		ManualHelper.addEntry("radio_station", getCategory(),
				...
				new ManualPages.ItemDisplay(ManualHelper.getManual(), "radio_station2",
						new ItemStack(IIContent.item_radio_configurator, 1, 0),
						new ItemStack(IIContent.item_radio_configurator, 1, 1)
				)
		);

		ManualHelper.addEntry("small_data_devices", getCategory(),
				new ManualPages.Crafting(ManualHelper.getManual(), "data_merger", new ItemStack(IIContent.block_metal_device, 1, IIBlockTypes_MetalDevice.DATA_MERGER.getMeta())),
				new ManualPages.Crafting(ManualHelper.getManual(), "data_router", new ItemStack(IIContent.block_metal_device, 1, IIBlockTypes_MetalDevice.DATA_ROUTER.getMeta())),
				new ManualPages.Crafting(ManualHelper.getManual(), "redstone_buffer", new ItemStack(IIContent.block_metal_device, 1, IIBlockTypes_MetalDevice.REDSTONE_BUFFER.getMeta())),
				new ManualPages.Crafting(ManualHelper.getManual(), "timed_buffer", new ItemStack(IIContent.block_metal_device, 1, IIBlockTypes_MetalDevice.TIMED_BUFFER.getMeta())),
				new ManualPages.Crafting(ManualHelper.getManual(), "small_data_buffer", new ItemStack(IIContent.block_metal_device, 1, IIBlockTypes_MetalDevice.SMALL_DATA_BUFFER.getMeta()))

		);

		ManualHelper.addEntry("programmable_speaker", getCategory(),
				new ManualPages.Crafting(ManualHelper.getManual(), "programmable_speaker0", new ItemStack(IIContent.block_data_connector, 1, IIBlockTypes_Connector.PROGRAMMABLE_SPEAKER.getMeta())),
