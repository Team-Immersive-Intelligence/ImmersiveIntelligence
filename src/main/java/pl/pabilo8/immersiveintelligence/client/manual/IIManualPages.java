...
public class IIManualPages
{
	...
	public static class DataVariablesCallbackDisplay extends ManualPages
	{
		List<CallbackEntry> entries = new ArrayList<>();
		String title;
		int titleShift;

		public DataVariablesCallbackDisplay(ManualInstance manual, String name)
		{
			super(manual, name+".vars_callback");
		}

		public DataVariablesCallbackDisplay addEntry(IDataType type, String... c)
		{
			if(c.length > 0)
