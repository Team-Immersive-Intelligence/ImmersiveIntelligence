...
public class GuiDataEditorBoolean extends GuiDataEditor<DataTypeBoolean>
{
	...
	public void init()
	{
		...
		buttonTrue = addButton(new GuiButtonState(0, x+16, y+12, 48, 12, I18n.format(CommonProxy.DATA_KEY+"datatype.boolean.true"), editedstate, TEX, 0, 234, 0));
		buttonFalse = addButton(new GuiButtonState(1, x+48+16, y+12, 48, 12, I18n.format(CommonProxy.DATA_KEY+"datatype.boolean.false"), !editedstate, TEX, 0, 234, 0));
