 ...
 * @since 17.05.2019
 */
@DecoTemplate(name = "metal_crate", category = DecoGuiCategory.GENERIC_TILE)
public class GuiMetalCrate extends DecoTileGui<TileEntityMetalCrate, ContainerIICrate<TileEntityMetalCrate>>
{
	...
	{
		startBackground()
				.withBox(DecoTextures.BG_STEEL, 0, 0, 176, 76)
				.withTitleBar(tile)
