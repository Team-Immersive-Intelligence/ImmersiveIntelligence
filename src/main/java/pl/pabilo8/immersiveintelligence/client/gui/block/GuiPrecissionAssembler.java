...
import pl.pabilo8.immersiveintelligence.common.block.multiblocks.metal.tileentities.first.TileEntityPrecissionAssembler;
...
public class GuiPrecissionAssembler extends GuiIEContainerBase
{
	...
	{
		this.fontRenderer.drawString(I18n.format("tile."+ImmersiveIntelligence.MODID+".metal_multiblock.precission_assembler.name"), 8, 6, IILib.COLOR_H1);
	}
