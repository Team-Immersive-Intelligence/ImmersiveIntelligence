...
public class GuiAmmunitionWorkshop extends GuiAmmunitionBase<TileEntityAmmunitionWorkshop>
{
	...
	public void initGui()
	{
		...
		addLabel(guiLeft+1, guiTop+8, 118, 0, Utils.COLOR_H1, I18n.format("tile.immersiveintelligence.metal_multiblock1.ammunition_workshop.name")).setCentered();
		...
		addLabel(guiLeft+122, guiTop+5+5, Utils.COLOR_H1, "Fuse:");
		addLabel(guiLeft+122, guiTop+5+5+32, Utils.COLOR_H1, "Parameters:");
	}
