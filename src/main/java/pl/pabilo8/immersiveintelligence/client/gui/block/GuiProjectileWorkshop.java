...
public class GuiProjectileWorkshop extends DecoGui<TileEntityProjectileWorkshop, ContainerProjectileWorkshop>
{
	...
	public void onInit()
	{
		...
		//Add background
		startBackground()
				.withBox(IIReference.GUI_BG_STEEL_ROUGH, IIReference.RES_TEXTURES_DECO_TEMPLATE_SQUARE, 0, 0, 256, 130)
				.withTitleBar(tile)
				.withNextLayer()
				.withBox(IIReference.GUI_BG_WOODEN, 44, 136, 176, 92)
				.withInventorySlots(SlotStyle.VANILLA, container.playerInventory)
				.withInventoryTitleBar()

				.conditionally(!hasFillerUpgrade, builder -> builder
						.withNextLayer()
						.withBox(IIReference.GUI_BG_STEEL_ROUGH, IIReference.RES_TEXTURES_DECO_TEMPLATE_SQUARE, 0, 0, 144, 130)
						.withInventorySlots(SlotStyle.IE_INPUT, container.inputSlot)

						.withNextLayer()
						.withBox(IIReference.GUI_BG_PAPER, IIReference.RES_TEXTURES_DECO_TEMPLATE_PAPER, 144, 0, 120, 130)

						.withNextLayer()
						.withBox(IIReference.GUI_BG_BLUEPRINT, IIReference.RES_TEXTURES_DECO_TEMPLATE_PAPER, 0, 86, 144, 44)
						.withBox(IIReference.GUI_BG_BLUEPRINT, IIReference.RES_TEXTURES_DECO_TEMPLATE_PAPER, 0, 14, 144, 72)

						.withNextLayer()
						.withBox(IIReference.GUI_BG_PAPER, IIReference.RES_TEXTURES_DECO_TEMPLATE_TICKET, 44, 18, 96, 72)
				)
				.build();
