 ...
 * @since 10.07.2019
 */
@DecoTemplate(name = "upgrade_tile", category = DecoGuiCategory.PRODUCTION_TILE)
public class GuiTileUpgrade<T extends TileEntityIEBase & IIEInventory & IUpgradableDevice> extends DecoTileGui<T, ContainerTileUpgrade<T>>
{
	...
	public GuiTileUpgrade(EntityPlayer player, T tile)
	{
		super(player, tile, IIGUI.UPGRADE_TILE);
