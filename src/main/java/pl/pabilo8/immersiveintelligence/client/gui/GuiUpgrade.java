...
public class GuiUpgrade extends GuiIEContainerBase
{
	...
	{
		if(mouseButton==0&&previewed==null&&Utils.isPointInRectangle(guiLeft+99, guiTop+8, guiLeft+99+66, guiTop+8+56, mouseX, mouseY))
		{
	...
	public void drawScreen(int mx, int my, float partial)
	{
		...
		else
		{
			...
			Utils.drawStringCentered(fontRenderer, getUpgradeNameTranslation(previewed), guiLeft+99, guiTop+8, 66, 1, 0xffffff);
		}
