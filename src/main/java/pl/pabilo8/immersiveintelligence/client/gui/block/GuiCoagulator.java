...
public class GuiCoagulator extends DecoGui<TileEntityCoagulator, ContainerCoagulator>
{
	...
	public void onInit()
	{
		startBackground()
				...
				.withInventorySlots(SlotStyle.IE_INPUT, container.slotBucketIn1)
				.withInventorySlots(SlotStyle.IE_OUTPUT, container.slotBucketOut1)
				.withInventorySlots(SlotStyle.IE_INPUT, container.slotBucketIn2)
				.withInventorySlots(SlotStyle.IE_OUTPUT, container.slotBucketOut2)
