 ...
 * @since 19.12.2024
 */
public class GuiButtonDataLetterListSide extends GuiButton
{
	...
	public GuiButtonDataLetterListSide(int buttonId, int x, int y, boolean hasEmpty, char currentValue, ArrowsAlignment arrows)
	{
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
	{
		...
		if (dropped)
		{
			...
			int dropdownX = x + width; // Adjust this value to reposition the dropdown horizontally to the right of the box
			int dropdownY = y + height - 18; // Adjust this value to reposition the dropdown vertically
