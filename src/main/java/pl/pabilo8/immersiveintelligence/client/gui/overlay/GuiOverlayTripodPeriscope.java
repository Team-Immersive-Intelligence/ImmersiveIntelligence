...
public class GuiOverlayTripodPeriscope extends GuiOverlayBase
{
	...
	{
		ClientUtils.font().drawString(I18n.format(IILib.INFO_KEY+"yaw", CameraHandler.getYaw()),
				(int)(width*0.5)+8, (int)(height*0.5)+8, 0xffffff, true);
		ClientUtils.font().drawString(I18n.format(IILib.INFO_KEY+"pitch", CameraHandler.getPitch()),
