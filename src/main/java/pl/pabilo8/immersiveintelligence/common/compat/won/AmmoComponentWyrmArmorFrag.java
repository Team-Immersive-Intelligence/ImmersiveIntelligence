...
public class AmmoComponentWyrmArmorFrag extends AmmoComponent

{
	...
	public IngredientStack getMaterial()
	{
		...
		return new IngredientStack(new ItemStack(wyrmshell, 1));
	}
	...
	public void onEffect(World world, Vec3d pos, Vec3d dir, ComponentEffectShape shape, NBTTagCompound tag, float componentSize, float multiplier, Entity owner)
	{
		...
		for(EntityLivingBase e : entities)
		{
			...
			e.addPotionEffect(new PotionEffect(IIPotions.radiation, 160, 1));
			e.attackEntityFrom(IIDamageSources.RADIATION_DAMAGE, 2);
