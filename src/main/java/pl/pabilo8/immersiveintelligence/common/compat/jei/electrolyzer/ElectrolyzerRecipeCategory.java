...
public class ElectrolyzerRecipeCategory extends IIRecipeCategory<ElectrolyzerRecipe, ElectrolyzerRecipeWrapper>
{
	...
	{
		super("electrolyzer", "tile."+ImmersiveIntelligence.MODID+".metal_multiblock.electrolyzer.name", helper.createBlankDrawable(140, 50), ElectrolyzerRecipe.class, new ItemStack(ImmersiveIntelligence.proxy.block_metal_multiblock, 1, IIBlockTypes_MetalMultiblock.ELECTROLYZER.getMeta()));
		tankOverlay = helper.createDrawable(background, 0, 52, 20, 51, -2, 2, -2, 2);
		machineStack = new ItemStack(ImmersiveIntelligence.proxy.block_metal_multiblock, 1, IIBlockTypes_MetalMultiblock.ELECTROLYZER.getMeta());
	}
