 ...
 * @since 2019-06-01
 */
public class EntityMinecartBarrelSteelIT extends EntityMinecartFluidContainer implements IMinecartBlockPickable
{
	public EntityMinecartBarrelSteelIT(World worldIn)
	{
		super(worldIn);
	}

	public EntityMinecartBarrelSteelIT(World worldIn, Vec3d vv)
	{
		super(worldIn, vv);
	}
	...
	{
		return BlockType_MetalBarrel.BARREL_STEEL.getMeta();
	}
