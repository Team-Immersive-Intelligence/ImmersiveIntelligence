...
public class AmmoComponentManducaterCore extends AmmoComponent

{
	public AmmoComponentManducaterCore ()
	{
		super("manducater_core", 1f, ComponentRole.SPECIAL, IIColor.fromPackedARGB(0x006d73));
	}

	@Override
	public IngredientStack getMaterial()
	{
		Item manducatercore = Item.REGISTRY.getObject(new ResourceLocation("srparasites", "ada_manducater_drop"));

		return new IngredientStack(new ItemStack(manducatercore, 1));
	}
	...
	public void onEffect(World world, Vec3d pos, Vec3d dir, ComponentEffectShape shape, NBTTagCompound tag, float size, float multiplier, Entity owner)
	{
		...
		new IIExplosion(world, owner, pos, dir,
				2, 0, ComponentEffectShape.ORB, false, false, false)
				.doExplosion();
		...
		{
			e2.addPotionEffect(new PotionEffect(IIPotions.exposed, 180, 1));
		}
