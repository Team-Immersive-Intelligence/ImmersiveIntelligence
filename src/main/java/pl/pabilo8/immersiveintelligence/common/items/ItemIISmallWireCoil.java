 ...
 * @since 2019-05-31
 */
public class ItemIISmallWireCoil extends ItemIIBase implements IWireCoil
{
	public ItemIISmallWireCoil()
	{
		super("small_wirecoil", 64, "redstone", "data");
	}

	@Override
	public WireType getWireType(ItemStack stack)
	{
		return stack.getMetadata()==0?IISmallWireType.SMALL_REDSTONE: IISmallWireType.SMALL_DATA;
	}

	@Override
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
	{
		tooltip.add(I18n.format(CommonProxy.DESCRIPTION_KEY+"small_wirecoil"));
