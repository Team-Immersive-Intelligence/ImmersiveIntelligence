...
public class ItemIIMeasuringCup extends ItemIIBase implements ITool, IAdvancedFluidItem, IItemScrollable
{
	...
	public void onCreated(ItemStack stack, World worldIn, EntityPlayer playerIn)
	{
		...
		ItemNBTHelper.setInt(stack, "maxCap", getCapacity(stack, Tools.measuring_cup_capacity));
	}
	...
	public ItemStack getContainerItem(ItemStack stack)
	{
		...
		else if(FluidUtil.getFluidContained(stack)!=null)
		{
			ItemStack ret = stack.copy();
			IFluidHandler handler = FluidUtil.getFluidHandler(ret);
			handler.drain(getCapacity(stack, Tools.measuring_cup_capacity), true);
			return ret;
		}
		return stack;
	}
	...
	{
		if(!stack.isEmpty())
			return new IEItemFluidHandler(stack, Tools.measuring_cup_capacity);
		return null;
	}
	...
	public int getCapacity(ItemStack stack, int baseCapacity)
	{
		...
		return Tools.measuring_cup_capacity;
	}
