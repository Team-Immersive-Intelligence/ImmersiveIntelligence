...
public class ItemIIBinoculars extends ItemIIBase implements IAdvancedZoomTool, IIEEnergyItem, ITextureOverride
{
	...
	{
		ImmersiveIntelligence.logger.info(key+" "+isEnabled(stack));
		return Arrays.asList(
				isEnabled(stack)?new ResourceLocation(ImmersiveIntelligence.MODID+":items/binoculars/infrared_binoculars_on"): new ResourceLocation(ImmersiveIntelligence.MODID+":items/binoculars/infrared_binoculars_off")
		);
	}
