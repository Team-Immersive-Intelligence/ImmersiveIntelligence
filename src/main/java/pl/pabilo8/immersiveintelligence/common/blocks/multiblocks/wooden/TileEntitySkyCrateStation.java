...
{
	public static ItemStack gear_iron = ItemStack.EMPTY;
	...
	public void update()
	{
		...
		if(!isDummy()&&!world.isRemote)
		{
			...
			if(cart!=null&&internalEntity!=null)
			{
				...
				if(animation==2)
				{
					float time = Math.min(1, progress/(SkycrateStation.minecartInTime*0.25f));
				...
				{
					float prog = progress/SkycrateStation.minecartOutTime;
	...
	public int getAnimationLength()
	{
		...
		{
			case 2:
				return SkycrateStation.minecartInTime;
			case 3:
				return SkycrateStation.minecartOutTime;
			case 4:
