...
public class MultiblockArtilleryHowitzer implements IMultiblock
{
	...
	static final IngredientStack[] materials = new IngredientStack[]{
			...
			new IngredientStack(new ItemStack(IIContent.blockMetalDecoration, 12, IIBlockTypes_MetalDecoration.ADVANCED_ELECTRONIC_ENGINEERING.getMeta())),
			new IngredientStack(new ItemStack(IIContent.blockMetalDecoration, 1, IIBlockTypes_MetalDecoration.ELECTRONIC_ENGINEERING.getMeta())),
		...
		for(int h = -5; h < 2; h++)
			for(int l = 0; l < 9; l++)
				for(int w = -4; w < 5; w++)
				{
					...
					world.setBlockState(pos2, IIContent.blockMetalMultiblock0.getStateFromMeta(IIBlockTypes_MetalMultiblock0.ARTILLERY_HOWITZER.getMeta()));
