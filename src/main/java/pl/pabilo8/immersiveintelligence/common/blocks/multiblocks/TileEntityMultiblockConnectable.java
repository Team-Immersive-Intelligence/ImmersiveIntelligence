package pl.pabilo8.immersiveintelligence.common.blocks.multiblocks;
...
public abstract class TileEntityMultiblockConnectable<T extends TileEntityMultiblockMetal<T, R>, R extends IMultiblockRecipe> extends TileEntityMultiblockMetal<T, R> implements IImmersiveConnectable
{
	...
	public void readCustomNBT(@Nonnull NBTTagCompound nbt, boolean descPacket)
	{
		...
		{
			ImmersiveIntelligence.logger.error("TileEntityMultiblockConnectable encountered MASSIVE error reading NBT. You should probably report this.");
			ImmersiveIntelligence.logger.catching(Level.ERROR, e);
		}
	}
	...
	public void writeCustomNBT(@Nonnull NBTTagCompound nbt, boolean descPacket)
	{
		...
		{
			ImmersiveIntelligence.logger.error("TileEntityMultiblockConenctable encountered MASSIVE error writing NBT. You should probably report this.");
			ImmersiveIntelligence.logger.catching(Level.ERROR, e);
		}
	}
		...
		if(world!=null&&world.isRemote&&!ClientUtils.mc().isSingleplayer()&&nbt!=null)
		{
			...
			for(int i = 0; i < connectionList.tagCount(); i++)
			{
				...
				if(con!=null)
				{
					...
					ImmersiveIntelligence.logger.error("CLIENT read connection as null from {}", nbt);
			}
		}
	}
