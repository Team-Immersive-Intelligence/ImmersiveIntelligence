...
public abstract class BlockIIMultiblock<E extends Enum<E> & BlockIIBase.IBlockEnum> extends BlockIITileProvider<E>
{
	...
	public BlockIIMultiblock(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockIEBase> itemBlock, Object... additionalProperties)
	{
