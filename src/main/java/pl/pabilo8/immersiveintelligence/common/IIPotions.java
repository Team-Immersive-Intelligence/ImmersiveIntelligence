...
public class IIPotions
{
	...
	public static void init()
	{
		...
		//23.04.2026 Carver: experiment: full paralysis potion effect. Inspired by s&r effect (taken motion and parameters). May be a replacement for neuroparalitic or a bonus effect to something else.
		...
		//TODO: Potentially need to remove registerPotionAttributeModifier if the effect apply trough the protection.
		//TODO: potentially Rework "suffocatordelayed" as it is potentially jank.

		//End of gas code experiments

		//Biological/viral agents. This one should spread to nearby entities and etc, making it viral. WIP. Names are subject to  change.
