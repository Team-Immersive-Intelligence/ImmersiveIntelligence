...
public class ItemIITripodPeriscope extends ItemIIBase implements IItemEntityPlacer<EntityTripodPeriscope>
{
	...
	@Nonnull
	@Override
	public EntityTripodPeriscope getPlacedEntity(World world, double x, double y, double z, ItemStack stack, float playerYaw, float playerPitch)
	{
		EntityTripodPeriscope periscope = new EntityTripodPeriscope(world);
		periscope.setPosition(x, y, z);
		periscope.aim.withCenterYaw(playerYaw);
		return periscope;
	}
}
