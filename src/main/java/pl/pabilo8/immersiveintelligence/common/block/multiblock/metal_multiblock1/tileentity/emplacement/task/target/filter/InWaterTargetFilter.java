...
/**
 * Matches the expected in-water state.
 *
 * @author Pabilo8 (pabilo@iiteam.net)
 * @since 30.08.2026
 */
public class InWaterTargetFilter extends BooleanTargetFilter
{
	public InWaterTargetFilter()
	{
	}

	public InWaterTargetFilter(boolean expected)
	{
		super(expected);
	}
	...
	{
		return TargetFilterType.IN_WATER;
	}
}
