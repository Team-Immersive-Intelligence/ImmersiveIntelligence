...
import pl.pabilo8.immersiveintelligence.common.IIConfigHandler.IIConfig.Machines.ConveyorScanner;
	...
	public void update()
	{
		...
		if(pos==1&&energyStorage.getEnergyStored() > 0&&!inventory.get(0).isEmpty())
		{
			...
			if(processTime >= 20)
			{
				...
				IDataConnector conn = IIUtils.findConnectorFacing(getBlockPosForPos(0), this.world, this.facing.rotateY());
				if(conn!=null)
				{
