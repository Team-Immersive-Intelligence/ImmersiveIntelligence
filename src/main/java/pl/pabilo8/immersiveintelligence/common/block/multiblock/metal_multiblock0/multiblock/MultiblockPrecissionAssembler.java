...
public class MultiblockPrecissionAssembler implements IMultiblock
{
	...
	public static MultiblockPrecissionAssembler INSTANCE;
	...
	public MultiblockPrecissionAssembler()
	{
		INSTANCE = this;
	}
		...
		for(int h = 0; h < 3; h++)
			for(int l = 0; l < 3; l++)
				for(int w = -2; w < 3; w++)
				{
					...
					world.setBlockState(pos2, IIContent.blockMetalMultiblock0.getStateFromMeta(IIBlockTypes_MetalMultiblock0.PRECISSION_ASSEMBLER.getMeta()));
