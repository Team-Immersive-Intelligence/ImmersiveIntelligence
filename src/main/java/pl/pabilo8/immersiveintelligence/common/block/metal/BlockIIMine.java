...
public abstract class BlockIIMine extends BlockIITileProvider<IIBlockTypes_Mine>
{
	...
	public static abstract class ItemBlockMineBase extends ItemBlockIEBase implements IAmmo
	{
		...
		{
			return IIUtils.getStackWithMetaName(IIContent.itemAmmoCasing, getName(), amount);
		}
