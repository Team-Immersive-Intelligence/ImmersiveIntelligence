 ...
 * @since 23.06.2020
 */
public class CommandReloadModels extends CommandIIBase
{

	public CommandReloadModels(CommandTreeBase parent)
	{
		super(parent, "model");
	}
	...
	{
		return "Reload one or all all registered 3D model renderers from Immersive Intelligence.";
	}
