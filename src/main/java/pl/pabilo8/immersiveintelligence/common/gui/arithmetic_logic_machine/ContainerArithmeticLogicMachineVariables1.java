 ...
 */
public class ContainerArithmeticLogicMachineVariables1 extends ContainerIEBase
{
	public ContainerArithmeticLogicMachineVariables1(InventoryPlayer inventoryPlayer, TileEntityArithmeticLogicMachine tile)
	{
		super(inventoryPlayer, tile);

		this.addSlotToContainer(new CircuitSlot(this, this.inv, 1, 5, 61));
