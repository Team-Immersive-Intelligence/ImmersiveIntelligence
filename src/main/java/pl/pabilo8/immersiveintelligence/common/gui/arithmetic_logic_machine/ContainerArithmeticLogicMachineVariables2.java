 ...
 */
public class ContainerArithmeticLogicMachineVariables2 extends ContainerIEBase
{
	public ContainerArithmeticLogicMachineVariables2(InventoryPlayer inventoryPlayer, TileEntityArithmeticLogicMachine tile)
	{
		super(inventoryPlayer, tile);

		this.addSlotToContainer(new CircuitSlot(this, this.inv, 2, 5, 61));
