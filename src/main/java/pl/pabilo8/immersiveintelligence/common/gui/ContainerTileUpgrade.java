 ...
 * @since 10.07.2019
 */
public class ContainerTileUpgrade<T extends TileEntityIEBase & IIEInventory & IUpgradableDevice> extends ContainerIITileBase<T>
{
	public ContainerTileUpgrade(EntityPlayer player, T tile)
	{
		super(player, tile);
		//Input/Output Slots
