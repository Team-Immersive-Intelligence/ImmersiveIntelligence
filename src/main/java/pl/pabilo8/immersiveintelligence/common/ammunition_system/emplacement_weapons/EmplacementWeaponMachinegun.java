...
public class EmplacementWeaponMachinegun extends EmplacementWeapon
{
	...
	public void shoot(TileEntityEmplacement te)
	{
		...
		if(!te.getWorld().isRemote)
		{
			...
			if(!s2.isEmpty())
			{
				te.getWorld().playSound(null, te.getPos().getX(), te.getPos().getY(), te.getPos().getZ(), IISounds.machinegun_shot_heavybarrel, SoundCategory.PLAYERS, 1F, 0.75f);
	...
	public void render(TileEntityEmplacement te, float partialTicks)
	{
		...
		Utils.bindTexture(EmplacementRenderer.textureMachinegun);
