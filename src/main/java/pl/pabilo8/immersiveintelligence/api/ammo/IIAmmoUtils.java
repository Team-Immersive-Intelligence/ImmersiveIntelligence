...
public class IIAmmoUtils
{
	...
	{
		IIPenetrationRegistry.registeredBlocks.put(iBlockState -> IIUtils.compareBlockstateOredict(iBlockState, "block"+IIUtils.toCamelCase(name, false)), handler);
		if(hasSlab)
			IIPenetrationRegistry.registeredBlocks.put(iBlockState -> IIUtils.compareBlockstateOredict(iBlockState, "slab"+IIUtils.toCamelCase(name, false)), handler);
		if(hasSheetMetal)
			IIPenetrationRegistry.registeredBlocks.put(iBlockState -> IIUtils.compareBlockstateOredict(iBlockState, "blockSheetmetal"+IIUtils.toCamelCase(name, false)), handler);
		if(hasSheetmetalSlab)
			IIPenetrationRegistry.registeredBlocks.put(iBlockState -> IIUtils.compareBlockstateOredict(iBlockState, "slabSheetmetal"+IIUtils.toCamelCase(name, false)), handler);
	...
	{
		for(Block b : blocks)
			IIPenetrationRegistry.registeredBlocks.put(iBlockState -> iBlockState.getBlock()==b, handler);
	}
