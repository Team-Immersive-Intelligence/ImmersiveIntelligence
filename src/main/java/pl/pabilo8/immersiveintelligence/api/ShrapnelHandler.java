...
public class ShrapnelHandler
{
	...
	public static void addShrapnel(String name, int color, String texture, int damage, float mass, float brightness)
	{
		if(!registry.containsKey(name))
			registry.put(name, new Shrapnel(name, texture, color, damage, mass, brightness));
	}
	...
	public static class Shrapnel
	{
		...
		private Shrapnel(String name, String texture, int color, int damage, float mass, float brightness)
		{
			this.name = name;
			this.color = color;
