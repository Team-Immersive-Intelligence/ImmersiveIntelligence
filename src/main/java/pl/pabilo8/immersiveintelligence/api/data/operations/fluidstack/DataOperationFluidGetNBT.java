 ...
 * @since 12.12.2024
 **/
@DataOperation.DataOperationMeta(name = "fluid_get_nbt",
		allowedTypes = {DataTypeFluidStack.class}, params = {"stack"},
		expectedResult = DataTypeString.class)
public class DataOperationFluidGetNBT extends DataOperation
{
	@Nonnull
	@Override
	public DataType execute(DataPacket packet, DataTypeExpression data)
	{
		...
		return new DataTypeString(fs.value==null?"": EasyNBT.wrapNBT(fs.value.tag).toString());
	}
}
