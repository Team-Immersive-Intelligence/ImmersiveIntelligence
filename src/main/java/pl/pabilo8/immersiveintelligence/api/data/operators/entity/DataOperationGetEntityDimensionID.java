 ...
 * @since 05-07-2019
 */
public class DataOperationGetEntityDimensionID extends DataOperator
{
	...
	{
		return new DataPacketTypeInteger(getVarInType(DataPacketTypeEntity.class, data.getType1(), packet).dimensionID);
	}
}
