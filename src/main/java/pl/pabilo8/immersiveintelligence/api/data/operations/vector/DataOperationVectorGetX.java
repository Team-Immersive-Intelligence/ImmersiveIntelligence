 ...
 * @since 15.11.2024
 **/
@DataOperation.DataOperationMeta(name = "vector_get_x",
		allowedTypes = {DataTypeVector.class}, params = {"vector"},
		expectedResult = NumericDataType.class)
public class DataOperationVectorGetX extends DataOperation
{
	@Nonnull
	@Override
	public DataType execute(DataPacket packet, DataTypeExpression data)
	{
		...
		return t1.integerVector?new DataTypeInteger((int)t1.x): new DataTypeFloat(t1.x);
	}
}
