 ...
 * @since 15.11.2024
 **/
@DataOperation.DataOperationMeta(name = "vector_add", expression = "+++",
		allowedTypes = {DataTypeVector.class, DataTypeVector.class}, params = {"vector", "vector"},
		expectedResult = DataTypeVector.class)
public class DataOperationVectorAdd extends DataOperation
{
	@Nonnull
	@Override
	public DataType execute(DataPacket packet, DataTypeExpression data)
	{
		...
		return new DataTypeVector(t1.x+t2.x, t1.y+t2.y, t1.z+t2.z);
	}
}
