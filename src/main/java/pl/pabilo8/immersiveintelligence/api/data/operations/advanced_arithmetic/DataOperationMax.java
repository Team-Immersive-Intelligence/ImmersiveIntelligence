...
public class DataOperationMax extends DataOperation
{
	...
	public DataType execute(DataPacket packet, DataTypeExpression data)
	{
		...
		if(t1 instanceof DataTypeFloat||t2 instanceof DataTypeFloat)
			return new DataTypeFloat(Math.max(t1.floatValue(), t2.floatValue()));
		return new DataTypeInteger(Math.max(t1.intValue(), t2.intValue()));
	}
}
