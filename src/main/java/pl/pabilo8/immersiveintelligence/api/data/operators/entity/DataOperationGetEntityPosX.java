 ...
 * @since 05-07-2019
 */
public class DataOperationGetEntityPosX extends DataOperator
{
	public DataOperationGetEntityPosX()
	{
	...
	{
		return new DataPacketTypeInteger((int)getVarInType(DataPacketTypeEntity.class, data.getType1(), packet).lastPos.x);
	}
}
