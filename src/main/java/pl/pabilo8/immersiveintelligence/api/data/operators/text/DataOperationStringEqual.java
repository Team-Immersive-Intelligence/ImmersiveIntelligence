 ...
 * @since 05-07-2019
 */
public class DataOperationStringEqual extends DataOperator
{
	public DataOperationStringEqual()
	{
		name = "string_equal";
		sign = "==";
	...
	public IDataType execute(DataPacket packet, DataPacketTypeExpression data)
	{
		...
		return new DataPacketTypeBoolean(t1.valueToString().equals(t2.valueToString()));
	}
}
