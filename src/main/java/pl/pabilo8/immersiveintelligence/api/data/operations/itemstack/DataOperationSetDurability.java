 ...
 * @since 05-07-2019
 */
@DataOperation.DataOperationMeta(name = "set_durability", allowedTypes = {DataTypeItemStack.class, DataTypeInteger.class}, params = {"stack", "damage"}, expectedResult = DataTypeItemStack.class)
