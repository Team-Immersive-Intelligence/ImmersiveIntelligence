 ...
 * @since 05-07-2019
 */
@DataOperation.DataOperationMeta(name = "item_set_count", allowedTypes = {DataTypeItemStack.class, DataTypeInteger.class}, params = {"stack", "count"}, expectedResult = DataTypeItemStack.class)
public class DataOperationItemStackSetCount extends DataOperation
{
	@Nonnull
	@Override
