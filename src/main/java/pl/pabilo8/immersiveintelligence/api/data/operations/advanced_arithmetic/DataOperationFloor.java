 ...
 * @since 05-07-2019
 */
@DataOperation.DataOperationMeta(name = "floor", allowedTypes = {NumericDataType.class}, params = {"number"}, expectedResult = DataTypeInteger.class)
public class DataOperationFloor extends DataOperation
{
	@Nonnull
	@Override
	public DataType execute(DataPacket packet, DataTypeExpression data)
	{
		...
		return new DataTypeInteger((int)Math.floor(t1.floatValue()));
	}
}
