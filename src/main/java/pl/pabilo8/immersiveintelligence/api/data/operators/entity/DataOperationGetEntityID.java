 ...
 * @since 05-07-2019
 */
public class DataOperationGetEntityID extends DataOperator
{
	public DataOperationGetEntityID()
	{
	...
	{
		return new DataPacketTypeInteger(getVarInType(DataPacketTypeEntity.class, data.getType1(), packet).entityID);
	}
}
