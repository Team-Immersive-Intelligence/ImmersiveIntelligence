 ...
 * @since 05-07-2019
 */
public class DataOperationGetEntityPosZ extends DataOperator
{
	...
	{
		return new DataPacketTypeInteger((int)getVarInType(DataPacketTypeEntity.class, data.getType1(), packet).lastPos.z);
	}
}
