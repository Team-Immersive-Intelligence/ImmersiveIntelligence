 ...
 * @since 22.04.2022
 */
public class POLInstructionExt extends POLInstruction
{
	private final char letter;
	private final Class<? extends IDataType> type;
	private final DataTypeWrapper text;

	public POLInstructionExt(char letter, IDataType rest, Class<? extends IDataType> type)
	{
		super(1);
		this.letter = letter;
